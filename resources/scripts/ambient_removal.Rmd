...
features.mat <- lapply(features.mat, function(x, cells) x[, cells], cells = cells)
...
if (params$adt_ambient_removal$skip) {
  ...
  decont.adt <- decontPro(features.mat[["Antibody Capture"]], cell_type = as.integer(Idents(seu)), delta_sd = 5e-5, background_sd = 5e-6)
