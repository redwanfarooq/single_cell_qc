...
if (params$adt_ambient_removal$skip) {
  ...
  decont.adt <- decontPro(features.mat[["Antibody Capture"]], cell_type = as.integer(Idents(seu)), delta_sd = params$adt_ambient_removal$delta_sd, background_sd = params$adt_ambient_removal$background_sd)
